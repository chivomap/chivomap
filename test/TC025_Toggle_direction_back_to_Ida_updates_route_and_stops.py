...
async def run_test():
    ...
    try:
        ...
        await page.locator('button:has-text("Regreso")').click()
        await asyncio.sleep(1)
        await page.locator('button:has-text("Ida")').click()
        await asyncio.sleep(1)

        assert await page.locator('text=Ruta').first.is_visible(), "Expected 'Ruta' to be visible"
        assert await page.locator('button:has-text("Ida")').is_visible(), "Expected 'Ida' button to be visible"
